...
class Subscription(BaseModel):
    ...
    def __repr__(self):
        return f"<Subscription(id={self.id}, organization_id={self.organization_id}, plan='{self.plan}')>"
...
class Invoice(BaseModel):
    ...
    def __repr__(self):
        return f"<Invoice(id={self.id}, organization_id={self.organization_id}, status='{self.status}')>"
