...
Handles API key management with scoped permissions and rate limiting.
"""
...
app = FastAPI(
    ...
    description="API key management service for VetrAI Platform",
...
# Include routers
app.include_router(keys_router, prefix=f"/api/{settings.api_version}/keys", tags=["keys"])
