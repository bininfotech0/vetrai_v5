...
Handles multi-channel notifications with template management and delivery queues.
"""
...
# Include routers
app.include_router(notifications_router, prefix=f"/api/{settings.api_version}/notifications", tags=["notifications"])
